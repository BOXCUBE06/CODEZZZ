...
class StudentNotifView extends StatefulWidget {
  const StudentNotifView({super.key});

  @override
  State<StudentNotifView> createState() => _StudentNotifViewState();
}

class _StudentNotifViewState extends State<StudentNotifView> {
